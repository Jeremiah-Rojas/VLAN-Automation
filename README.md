...
</br>The following lab shows how a python script can automate the creation of VLANs and assign users to them keeping the traffic isolated from each other.  This lab was inspired/closely based off a lab performed by David Bombal.
